...
- Bilingual (English & Spanish): tap the **EN / ES** button in the header (next to the theme toggle) to switch. Menus, labels, and dropdown options translate; your stored data stays language-independent, so a journal is portable across languages. Edit `config/i18n_es.json` to tweak the Spanish wording.
