...
let I18N = {
  en: {
    ...
    'hist.egg': 'Egg', 'hist.heavyMeal': 'Heavy meal',
    ...
    'pat.daysLogged': 'Days logged', 'pat.vomitRate': 'Vomit rate',
    'pat.sinceLast': 'Days since last episode', 'pat.last30': 'Episodes (last 30 days)',
    'pat.monthlyTitle': 'Vomiting by month', 'pat.monthlyTotal': '{n} episodes in the last 6 months',
    'pat.month.hint': 'Tap a bar to see that month', 'pat.month.close': 'Close',
    'pat.month.none': 'No episodes this month', 'pat.month.onThoseDays': 'On those days',
    ...
    // Patterns — sleep influence (next-night)
    'pat.sleep.title': 'What affects his sleep?',
    'pat.sleep.intro': 'Share of the following night that was poor or very poor, after days with each thing below — compared with his baseline. Needs back-to-back logged days.',
    'pat.sleep.baseline': 'Baseline poor sleep: {p}', 'pat.sleep.pairs': '{n} back-to-back day pairs',
    'pat.sleep.needMore': 'Log on consecutive days to unlock this — it needs at least {min} back-to-back day pairs (you have {n}).',
    'pat.sleep.rowSub': '{hits} of {total} nights poor',
    'pat.sleep.chartTotal': '{n} poor nights in the last 6 months',
    'pat.sleep.nightOne': 'poor night',
    'pat.sleep.nightMany': 'poor nights',
    'pat.sleep.month.none': 'No poor nights this month',
    'pat.sleep.month.unknown': 'previous day not logged',
    'pat.sleep.month.precededBy': 'Preceded by',
    'pat.sleep.better': 'better',
    'pat.sleep.worse': 'worse',
    'pat.sleep.lowSampleList': 'Not enough data yet: {list}',
    'pat.sleep.exp.vomiting': 'After vomiting', 'pat.sleep.exp.illness': 'After illness signs', 'pat.sleep.exp.heavy': 'After a heavy meal',
  ...
  es: {
    ...
    'hist.egg': 'Huevo', 'hist.heavyMeal': 'Comida pesada',
    ...
    'pat.daysLogged': 'Días registrados', 'pat.vomitRate': 'Tasa de vómito',
    'pat.sinceLast': 'Días desde el último episodio', 'pat.last30': 'Episodios (últimos 30 días)',
    'pat.monthlyTitle': 'Vómitos por mes', 'pat.monthlyTotal': '{n} episodios en los últimos 6 meses',
    'pat.month.hint': 'Toca una barra para ver ese mes', 'pat.month.close': 'Cerrar',
    'pat.month.none': 'Sin episodios este mes', 'pat.month.onThoseDays': 'En esos días',
    ...
    // Patrones — influencia en el sueño (noche siguiente)
    'pat.sleep.title': '¿Qué afecta su sueño?',
    'pat.sleep.intro': 'Proporción de la noche siguiente que fue mala o muy mala, tras los días con cada factor de abajo, comparada con su base. Requiere días registrados consecutivos.',
    'pat.sleep.baseline': 'Base de mal sueño: {p}', 'pat.sleep.pairs': '{n} pares de días consecutivos',
    'pat.sleep.needMore': 'Registra días consecutivos para desbloquear esto: necesita al menos {min} pares de días seguidos (tienes {n}).',
    'pat.sleep.rowSub': '{hits} de {total} noches malas',
    'pat.sleep.chartTotal': '{n} noches malas en los últimos 6 meses',
    'pat.sleep.nightOne': 'noche mala',
    'pat.sleep.nightMany': 'noches malas',
    'pat.sleep.month.none': 'Sin noches malas este mes',
    'pat.sleep.month.unknown': 'día anterior sin registrar',
    'pat.sleep.month.precededBy': 'Precedido por',
    'pat.sleep.better': 'mejor',
    'pat.sleep.worse': 'peor',
    'pat.sleep.lowSampleList': 'Aún no hay datos suficientes: {list}',
