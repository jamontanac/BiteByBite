...
let I18N = {
  en: {
    ...
    'pat.sleep.rowSub': '{hits} of {total} nights poor', 'pat.sleep.vsBaseline': 'vs {p} baseline', 'pat.sleep.lowSample': 'not enough data yet',
  ...
  es: {
    ...
    'pat.sleep.rowSub': '{hits} de {total} noches malas', 'pat.sleep.vsBaseline': 'vs {p} base', 'pat.sleep.lowSample': 'aún no hay datos suficientes',
